...
//   const result = tempInCelsius * 1.8 + 32;
//   return `${tempInCelsius} degrees celsius is ${result} degrees fahrenheit`;
// };
...
//   return snickersPerDay * 365 * yearsLeft;
// };
